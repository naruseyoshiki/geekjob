...
public class UserDataDAO {
    ...
    public ArrayList<UserDataDTO> search(UserDataDTO ud) throws SQLException {
        ...
        try {
            ...
            //〇DTOに検索結果の値を格納し、ArrayListに格納
            ArrayList<UserDataDTO> DTOlist = new ArrayList<UserDataDTO>();
            while (rs.next()) {
